...
const MaleWashroomScreen = () => {
  const [location, setLocation] = useState(null);
  const [washrooms, setWashrooms] = useState([
    { id: 1, latitude: 9.883306483055637, longitude: 78.08300952672789, title: "Common Washroom" },
    { id: 2, latitude: 9.882802315502483, longitude: 78.0837882767329, title: "CSE Dept Wahrooom" },
    { id: 3, latitude: 9.882646100220258, longitude: 78.08374432439244, title: "IT Men's Washroom" },
    { id: 4, latitude: 9.881030364329915, longitude: 78.08362383534514, title: "TCE EIACP PC-RP Washroom" },
    { id: 5, latitude: 9.881900489493857, longitude: 78.08265066457459, title: "B Hall Washroom" },
    { id: 6, latitude: 9.882724715965482, longitude: 78.0830986484796, title: "ECE Dept Washroom" },
  ]);
...
const styles = StyleSheet.create({
  ...
  modalTitle: {
    fontSize: 20,
    fontWeight: 'bold',
    color: '#4A90E2', // Blue color for male washroom alert
    marginBottom: 10,
    textAlign: 'center',
  },
  modalText: {
...
export default MaleWashroomScreen;
